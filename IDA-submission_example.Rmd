...
* Assignment write-ups have a **limit of pages**. If you exceed them, some points will be deducted.

# About this template

This template is for guiding you how to hand in your homeworks with R Markdown. Some important remarks:
...
* Remind, your write-up DOES NOT have to contain unnecesary code. Save space for your analysis and results that help your analysis.
...
* Do not forget to submit your R code along with your write-up. If you used R Markdown, you are good to upload your .Rmd file instead of the .R file as long as it has all the code you used.
